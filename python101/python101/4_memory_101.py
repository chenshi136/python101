...
def roles(role_name):
    role_dict = {
        "老王": """一个50多岁的管家,在府上工作了20年,忠诚老实但最近因为儿子欠债而经济困难。案发时声称在整理账本，但没人能证明。""",
        "小翠": """18岁的丫鬟,聪明伶俐,深得小姐信任。但她暗恋府上的教书先生，而教书先生最近和小姐走得很近。案发时她说自己在厨房准备茶点。""",
        
        "小张": """25岁的年轻书生,来府上教书才3个月。家境贫寒但才学出众,和小姐互生情愫。案发时他说在书房读书，但丫鬟小翠说看到了他。"""
        
        }
    return role_dict.get(role_name, "你是一个友好的助手")  # ✅ 返回角色，如果不存在则返回默认值

role_system = roles("小翠") 
...
如果用户没有表达结束意图，则正常扮演{resolve_name}角色。"""
